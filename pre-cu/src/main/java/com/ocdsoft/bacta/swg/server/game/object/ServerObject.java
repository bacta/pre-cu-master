...
public abstract class ServerObject extends GameObject {
     ...
     */
    public final void sendCreateAndBaselinesTo(final Set<SoeUdpConnection> clients) {
        ...
        if (container != null) {
            final Iterator<ServerObject> containerIterator = container.iterator();

            while (containerIterator.hasNext()) {
                final ServerObject object = containerIterator.next();

                object.sendCreateAndBaselinesTo(clients);
            }
        }

        final SceneEndBaselines endBaselines = new SceneEndBaselines(networkId);
    ...
    public final void sendDestroyTo(final Set<SoeUdpConnection> clients) {
        ...
        for (final SoeUdpConnection client : clients) {
            ...
            if (msg == null)
                msg = new SceneDestroyObject(this);
